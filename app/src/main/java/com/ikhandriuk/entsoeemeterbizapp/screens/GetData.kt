...
class GetData : AppCompatActivity() {
            ...
            retrofitData.enqueue(object : Callback<ParametersItem?> {
                override fun onResponse(
                    ...
                    if (!response.isSuccessful) {
                        Toast.makeText(this@GetData, response.code().toString(), Toast.LENGTH_LONG)
                            .show()
                        return
                    }
    ...
    fun serializeDataItem()
    {
        val data=listOf(
            ParamItem(0, ddata = null,bdata = null),
            ParamItem(2, ddata = null,bdata = null),
        )
